...
export const encryptApi = {
  ...
  testRequestEncrypt: (param) => {
    return postEncryptRequest(prefix+'/support/apiEncrypt/testRequestEncrypt', param);
  },
  ...
  testResponseEncrypt: (param) => {
    return postRequest(prefix+'/support/apiEncrypt/testResponseEncrypt', param);
  },
  ...
  testDecryptAndEncrypt: (param) => {
    return postEncryptRequest(prefix+'/support/apiEncrypt/testDecryptAndEncrypt', param);
  },
   ...
   */
  testArray : (param) => {
    return postEncryptRequest(prefix+'/support/apiEncrypt/testArray', param);
  },
